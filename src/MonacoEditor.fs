...
// This file was generated and then errors manually fixed. The ts2fable tool is not perfect and some members
// may be missing or have just obj type. Check the node_modules/monaco-editor/monaco.d.ts file for reference.
...
module Monaco =
    ...
    module Editor =
        ...
        type [<AllowNullLiteral>] IComputedEditorOptions =
            abstract get: id: 'T -> FindComputedEditorOptionValueById

        type [<AllowNullLiteral>] IEditorOption<'K1, 'V> =
            abstract id: EditorOption
        ...
        type [<AllowNullLiteral>] FindEditorOptionsKeyById =
            interface end
        ...
        type [<AllowNullLiteral>] ICodeEditor =
            ...
            abstract getOption: id: 'T -> FindComputedEditorOptionValueById
    ...
    module Languages =
        ...
        module Typescript =
            ...
            type [<AllowNullLiteral>] LanguageServiceDefaults =
                ...
                /// documents, like `jquery.d.ts`.</summary>
                /// <param name="content">The file content</param>
                /// <param name="filePath">An optional file path</param>
                abstract addExtraLib: content: string * ?filePath: string -> IDisposable
                /// <summary>Remove all existing extra libs and set the additional source
                /// files to the language service. Use this for typescript definition
                /// files that won't be loaded as editor documents, like `jquery.d.ts`.</summary>
