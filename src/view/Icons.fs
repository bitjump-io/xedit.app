...
let VerticalBar () =
    JSX.jsx
        $"""
          ...
          <SvgIcon stroke="white" strokeWidth="1" viewBox="0 0 3 50" style={[Feliz.style.height 38; Feliz.style.custom ("margin", "auto"); Feliz.style.marginLeft 0; Feliz.style.marginRight 0]}>
...
type private Mdi =
  static member inline icon props = Interop.createElement (importDefault "@mdi/react/Icon") props
...
let mouseLeftClickIcon(): XIcon = 
  { Element = 
      Mdi.icon [
        ...
        icon.size "32px"
        prop.style [Feliz.style.margin (-10, -7, -12)]
...
let mouseScrollIcon(): XIcon = 
  { Element = 
      Mdi.icon [
        ...
        icon.size "20px"
        prop.style [Feliz.style.margin (0, 0, -6, 0)]
